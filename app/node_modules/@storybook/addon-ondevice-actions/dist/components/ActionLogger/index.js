...
exports.ActionLogger = function (_a) {
    ...
    return (react_1.default.createElement(react_native_1.ScrollView, null,
        react_1.default.createElement(react_native_1.ScrollView, { horizontal: true },
            react_1.default.createElement(react_native_1.View, null, actions.map(function (action) { return (react_1.default.createElement(react_native_1.View, { key: action.id, style: { flexDirection: 'row' } },
