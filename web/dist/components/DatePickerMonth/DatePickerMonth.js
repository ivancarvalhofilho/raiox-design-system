...
var MonthByYearSelectorStyled = _styledComponents.default.div(
  _templateObject(),
  _js.default.styles.shadow.level1,
  _js.default.styles.border.radius.sm,
  _js.default.styles.spacing.squish.xs,
)
...
function DatePickerMonth(props) {
  var _useState = (0, _react.useState)(
    (0, _dayjs.default)(props.dateSelected, 'YYYY-MM').get('year'),
  )

  var _useState2 = _slicedToArray(_useState, 2)

  var year = _useState2[0]

  var setYear = _useState2[1]
