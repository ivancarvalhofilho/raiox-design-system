...
var MonthListStyle = _styledComponents["default"].div(_templateObject(), "".concat(_theme["default"].styles.spacing.stack.nano, " ").concat(_theme["default"].styles.spacing.inline.xs), _theme["default"].styles.spacing.stack.nano);

var Month = _styledComponents["default"].div(_templateObject2(), function (props) {
  return props.selected && _theme["default"].colors.brand.primary.darkest;
}, function (props) {
  return props.active && 'pointer';
}, function (props) {
  return !props.active && _theme["default"].styles.opacity.level.light;
}, function (props) {
  return (0, _FontUtil["default"])(props.theme, 'body', 'regular', 'xs', props.selected ? 'neutral.light.base' : 'neutral.dark.base');
}, _theme["default"].styles.border.radius.sm);
