...
var MonthListStyle = _styledComponents.default.div(
  _templateObject(),
  ''
    .concat(_js.default.styles.spacing.stack.nano, ' ')
    .concat(_js.default.styles.spacing.inline.xs),
  _js.default.styles.spacing.stack.nano,
)

var Month = _styledComponents.default.div(
  _templateObject2(),
  function(props) {
...
function MonthList(props) {
  function generateDate(month) {
    return (0, _dayjs.default)(
      ''.concat(month, '/01/').concat(props.yearSelected),
    ).format('YYYY-MM')
  }
  ...
  var monthsArray = months.map(function(months, index) {
    return {
      ...
      active:
        ...
        props.months.some(function(month) {
  ...
  return /* #__PURE__ */ _react.default.createElement(
    MonthListStyle,
    null,
    monthsArray.map(function(month, index) {
      return /* #__PURE__ */ _react.default.createElement(
        Month,
        {
