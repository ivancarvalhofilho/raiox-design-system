...
var Title = _styledComponents.default.div(_templateObject3(), function(props) {
  return (0,
  _FontUtil.default)(props.theme, 'head', 'bold', 'md', 'brand.secondary.dark')
})

var LeftModalContent = _styledComponents.default.div(_templateObject4())

var LeftModalContainer = _styledComponents.default.div(
  _templateObject5(),
  function(props) {
    return props.show
      ? '0px'
      : '-'.concat(props.width ? props.width : 5000, 'px')
  },
)
...
var SideModal = function SideModal(props) {
  ...
  var width = _useState4[0]

  var setWidth = _useState4[1]
