...
var Svg = (0, _styledComponents.default)(_reactSvgInline.default)(
  _templateObject(),
  function(props) {
...
var Icon = function Icon(props) {
  ...
  function getIconSvgSize(props) {
    if (
      props.size &&
      !Object.keys(_js.default.styles.icon.size).includes(props.size)
    ) {
      return props.size
    }

    return (
      _js.default.styles.icon.size[props.size] ||
      _js.default.styles.icon.size.sm
    )
  }
...
Icon.propTypes = {
  ...
  spin: _propTypes.default.oneOfType([
