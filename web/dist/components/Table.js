...
var _reactInfiniteScrollComponent = _interopRequireDefault(
...
var LoaderContainer = _styledComponents.default.div(
  _templateObject(),
  function(props) {
...
var Container = _styledComponents.default.div(
  ...
  function(props) {
    return (
      (props.hasColor ? '8px ' : '') +
      props.cols.splice(props.color ? 1 : 0).reduce(function(x, y, index) {
        return ''
          .concat(x, ' minmax(')
          .concat(
            props.colHeadersWidth[index]
              ? ''.concat(props.colHeadersWidth[index], 'px')
              : 'auto',
            ',auto)',
          )
      }, '')
...
var ContainerInfinite = (0, _styledComponents.default)(
  _reactInfiniteScrollComponent.default,
)(
  _templateObject3(),
  function(props) {
    return props.optional && '-12px'
...
var DisplayGrid = _styledComponents.default.div(_templateObject5(), function(
  props,
) {
  return props.theme.fonts.family.body
})

var ContainerHeader = _styledComponents.default.div(
  _templateObject6(),
  function(props) {
    return ''
      .concat(props.theme.styles.border.width.hairline, ' solid ')
      .concat(props.theme.colors.neutral.dark['03'])
  },
  function(props) {
  ...
  function(props) {
    return props.colsWidth.length > 0
      ? (props.hasColor ? '8px ' : '') +
          props.colsWidth.reduce(function(x, y, index) {
            return ''.concat(
              x,
              ' minmax(',
              ''.concat(props.colsWidth[index], 'px'),
              ', auto)',
            )
          }, '')
      : ''
          .concat(props.hasColor ? '8px ' : '', ' repeat(')
          .concat(props.cols.length, ', auto)')
  },
)
...
var Children = _styledComponents.default.div(
  _templateObject11(),
  function(props) {
    return props.color
  },
...
function Table(props) {
  ...
  var optionalMouse = _useState2[0]

  var setOptionalMouse = _useState2[1]

  var _useState3 = (0, _react.useState)(0)

  var _useState4 = _slicedToArray(_useState3, 2)

  var childrenSize = _useState4[0]

  var setChildrenSize = _useState4[1]
  ...
  var colsWidth = _useState6[0]

  var setColsWidth = _useState6[1]

  var _useState7 = (0, _react.useState)([])

  var _useState8 = _slicedToArray(_useState7, 2)

  var colHeadersWidth = _useState8[0]

  var setColHeadersWidth = _useState8[1]
                  ...
                  props.data[key].ordenable &&
                    /* #__PURE__ */ _react.default.createElement(
                      _Icon.default,
                      {
                        path:
                          props.orderBy !== key
                            ? _js.default.icons['arrow-horizontal']
                            : props.order === 'DESC'
                            ? _js.default.icons['arrow-up']
                            : _js.default.icons['arrow-down'],
                      },
                    ),
                ),
              ),
        ...
        /* #__PURE__ */ _react.default.createElement(
                    ...
                    return /* #__PURE__ */ _react.default.createElement(
                      Row,
                      {
                        ...
                        ref: function ref(_ref3) {
                          return indexRow === 0 && key !== 'colors'
                            ? (items.current[indexCol] = _ref3)
                            : null
                        },
                      },
                      /* #__PURE__ */ _react.default.createElement(
                        ...
                        props.data[key].template
                          ? props.data[key].template(
                              ...
                              props.data[key].params &&
                                props.data[key].params.map(function(param) {
                                  return (
                                    props.data[param] &&
          ...
          /* #__PURE__ */ _react.default.createElement(
            ...
            /* #__PURE__ */ _react.default.createElement(
              ...
              (props.complete ? cols : colsOriginal).map(function(
                key,
                indexCol,
              ) {
                return /* #__PURE__ */ _react.default.createElement(
