...
var ModalHeader = _styledComponents["default"].div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n"])));

var Title = _styledComponents["default"].div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral([""])));

var ModalContent = _styledComponents["default"].div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  padding: 20px;\n"])));

var ModalContainer = _styledComponents["default"].div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  box-shadow: 0px 0px 8px rgba(0, 39, 64, 0.1);\n  border-radius: 5px;\n  width: 520px;\n  transition: top 0.5s;\n  background: white;\n  position: absolute;\n  top: ", ";\n  padding: 17px;\n  height: 436px;\n"])), function (props) {
