...
var MonthByYearSelectorStyled = _styledComponents["default"].div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  box-shadow: ", ";\n  border-radius: ", ";\n  padding: ", ";\n"])), _tokens.Tokens.shadow.level1, _tokens.Tokens.border.radius.sm, _tokens.Tokens.spacing.squish.xs);
...
function DatePickerMonth(props) {
  ...
  var wrapperRef = (0, _clickHandleUtil.handleOutsideDivClick)(function () {
    return !!props.setComponentVisibility && props.setComponentVisibility(false);
  });
  return /*#__PURE__*/_react["default"].createElement(MonthByYearSelectorStyled, {
    ref: wrapperRef
  }, /*#__PURE__*/_react["default"].createElement(_YearNavigator["default"], {
    yearSelected: year,
