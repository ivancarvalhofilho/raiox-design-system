...
var ContainerDatepicker = _styledComponents["default"].div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  position: relative;\n"])));

var CalendarIcon = _styledComponents["default"].div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  background: ", ";\n  border-radius: 0 5px 5px 0;\n  width: 40px;\n  height: 40px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n"])), _tokens.Tokens.colors.brand.primary.darkest);

var ContainerDate = _styledComponents["default"].div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  padding: 0 ", ";\n  display: flex;\n"])), _tokens.Tokens.spacing.inset.xs);
...
var Date = _styledComponents["default"].div(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  ", ";\n  color: ", ";\n  line-height: 15px;\n  display: flex;\n  align-items: center;\n\n  color: ", ";\n"])), (0, _FontUtil.fontStyleMaker)({
  fontFamily: "body",
  fontWeight: "medium",
  fontSize: "xxs"
}), _tokens.Tokens.colors.neutral.dark.base, _tokens.Tokens.colors.neutral.dark["03"]);

var DatepickerContainer = _styledComponents["default"].div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  background: #ffffff;\n  box-shadow: ", ";\n  border-radius: ", ";\n  width: 514px;\n  ", ";\n  top: 48px;\n  z-index: 1000;\n  position: absolute;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n"])), _tokens.Tokens.shadow.level1, _tokens.Tokens.border.sm, function (props) {
  return props.alignContainer === 'center' ? 'left: -150px' : "".concat(props.alignContainer, ": 0");
});

var Container = _styledComponents["default"].div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  background: #ffffff;\n  box-shadow: 0px 9px 46px rgba(0, 0, 0, 0.12);\n  border-radius: 4px;\n  display: flex;\n  //height: 315px;\n  justify-content: space-between;\n"])));

var MonthContainer = _styledComponents["default"].div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  flex: 1;\n"])));

var MonthTitle = _styledComponents["default"].div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  ", ";\n  color: ", ";\n"])), (0, _FontUtil.fontStyleMaker)({
  fontFamily: "body",
  fontWeight: "regular",
  fontSize: "xs"
}), _tokens.Tokens.colors.neutral.dark.base);

var MonthHeader = _styledComponents["default"].div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  padding: 16px;\n  display: flex;\n  justify-content: space-between;\n  flex: 1;\n  align-items: center;\n"])));
...
var BlockMessage = _styledComponents["default"].div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  height: 58px;\n  background: ", ";\n  padding: 8px 13px;\n  display: flex;\n  align-items: center;\n  ", ";\n  color: ", ";\n"])), _tokens.Tokens.colors.feedback.danger.light, (0, _FontUtil.fontStyleMaker)({
  fontFamily: "body",
  fontWeight: "medium",
  fontSize: "xs"
}), _tokens.Tokens.colors.neutral.dark.dark);

var Day = _styledComponents["default"].div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: 100%;\n  height: 100%;\n  cursor: ", ";\n  background-color: ", ";\n  ", ";\n  color: ", ";\n  ", "\n      ", "\n      ", "\n"])), function (props) {
  return props.disabled ? 'not-allowed' : props.onClick && 'pointer';
}, function (props) {
  return props.selected && _tokens.Tokens.colors.brand.primary.medium;
}, (0, _FontUtil.fontStyleMaker)({
  fontFamily: "body",
  fontWeight: "medium",
  fontSize: "xxs"
}), function (props) {
  return props.disabled ? _tokens.Tokens.colors.neutral.dark['02'] : _tokens.Tokens.colors.neutral.dark.base;
}, function (props) {
  return (props.first || props.last) && "color: ".concat(_tokens.Tokens.colors.neutral.light.base, ";\n  background: ").concat(_tokens.Tokens.colors.brand.primary.darkest, ";");
}, function (props) {
...
var DayBackground = _styledComponents["default"].div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  background-color: ", ";\n  background-color: ", ";\n  border-radius: ", ";\n  border-radius: ", ";\n  border-radius: ", ";\n  border-radius: ", ";\n"])), function (props) {
  return props.selected && _tokens.Tokens.colors.brand.primary.medium;
}, function (props) {
  return props.disabled && _tokens.Tokens.colors.neutral.dark['03'];
}, function (props) {
...
var DayHeader = (0, _styledComponents["default"])(Day)(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  ", ";\n  color: ", "\n"])), (0, _FontUtil.fontStyleMaker)({
  fontFamily: "body",
  fontWeight: "regular",
  fontSize: "xxs"
...
var Datepicker = function Datepicker(props) {
  ...
  return /*#__PURE__*/_react["default"].createElement(ContainerDatepicker, {
    ...
    path: _tokens.Tokens.icons.calendar,
    size: "22px",
    appearance: "light"
    ...
    return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, {
      ...
      path: _tokens.Tokens.icons['double-arrow-left'],
      size: "14px",
      ...
      path: _tokens.Tokens.icons['single-arrow-left'],
      size: "14px",
      ...
      path: _tokens.Tokens.icons['single-arrow-right'],
      size: "14px",
      style: {
        marginRight: '8px'
      },
      ...
      path: _tokens.Tokens.icons['double-arrow-right'],
      size: "14px",
